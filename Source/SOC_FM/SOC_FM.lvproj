...
<Project Type="Project" LVVersion="15008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Type Definitions" Type="Folder">
			...
			<Item Name="SOC_FM Analysis Configuration.ctl" Type="VI" URL="../controls/SOC_FM Analysis Configuration.ctl"/>
			<Item Name="SOC_FM Data.ctl" Type="VI" URL="../controls/SOC_FM Data.ctl"/>
			<Item Name="SOC_FM Graph Data.ctl" Type="VI" URL="../controls/SOC_FM Graph Data.ctl"/>
			<Item Name="SOC_FM HW Configuration.ctl" Type="VI" URL="../controls/SOC_FM HW Configuration.ctl"/>
			<Item Name="SOC_FM New Data Behavior.ctl" Type="VI" URL="../controls/SOC_FM New Data Behavior.ctl"/>
			<Item Name="SOC_FM Simulated Signal Type.ctl" Type="VI" URL="../controls/SOC_FM Simulated Signal Type.ctl"/>
			<Item Name="SOC_FM State.ctl" Type="VI" URL="../controls/SOC_FM State.ctl"/>
			<Item Name="SOC_FM UI References.ctl" Type="VI" URL="../controls/SOC_FM UI References.ctl"/>
			<Item Name="SOC_FM User Specified Data.ctl" Type="VI" URL="../controls/SOC_FM User Specified Data.ctl"/>
		</Item>
		<Item Name="SubVIs" Type="Folder">
			<Property Name="NI.SortType" Type="Int">0</Property>
			<Item Name="Utility VIs" Type="Folder">
				<Property Name="NI.SortType" Type="Int">0</Property>
				<Item Name="SOC_FM Analysis Configuration Dialog.vi" Type="VI" URL="../subVIs/SOC_FM Analysis Configuration Dialog.vi"/>
				<Item Name="SOC_FM Get Configuration File Path.vi" Type="VI" URL="../subVIs/SOC_FM Get Configuration File Path.vi"/>
				<Item Name="SOC_FM Get Scale Labels.vi" Type="VI" URL="../subVIs/SOC_FM Get Scale Labels.vi"/>
				<Item Name="SOC_FM Incorporate New Data.vi" Type="VI" URL="../subVIs/SOC_FM Incorporate New Data.vi"/>
				<Item Name="SOC_FM Load Configuration Settings from XML.vi" Type="VI" URL="../subVIs/SOC_FM Load Configuration Settings from XML.vi"/>
				<Item Name="SOC_FM Save Configuration Settings to XML.vi" Type="VI" URL="../subVIs/SOC_FM Save Configuration Settings to XML.vi"/>
				<Item Name="SOC_FM Set Enable State on Multiple Controls.vi" Type="VI" URL="../subVIs/SOC_FM Set Enable State on Multiple Controls.vi"/>
			</Item>
			<Item Name="SOC_FM Acquire Data from Hardware.vi" Type="VI" URL="../subVIs/SOC_FM Acquire Data from Hardware.vi"/>
			<Item Name="SOC_FM Copy Graph to Clipboard.vi" Type="VI" URL="../subVIs/SOC_FM Copy Graph to Clipboard.vi"/>
			<Item Name="SOC_FM Export Data.vi" Type="VI" URL="../subVIs/SOC_FM Export Data.vi"/>
			<Item Name="SOC_FM Load Data.vi" Type="VI" URL="../subVIs/SOC_FM Load Data.vi"/>
			<Item Name="SOC_FM Save Data.vi" Type="VI" URL="../subVIs/SOC_FM Save Data.vi"/>
			<Item Name="SOC_FM Settings Dialog.vi" Type="VI" URL="../subVIs/SOC_FM Settings Dialog.vi"/>
			<Item Name="SOC_FM Statistical Analysis.vi" Type="VI" URL="../subVIs/SOC_FM Statistical Analysis.vi"/>
		</Item>
		<Item Name="Result Dialog" Type="Folder">
			<Item Name="ResultDialog.vi" Type="VI" URL="../resultDialog/ResultDialog.vi"/>
		</Item>
		<Item Name="SOC_FM Main.vi" Type="VI" URL="../SOC_FM Main.vi"/>
		<Item Name="AbstractCalcLib.lvlibp" Type="LVLibp" URL="../../../PPL/AbstractCalcLib.lvlibp">
			<Item Name="AbstractCalc.lvclass" Type="LVClass" URL="../../../PPL/AbstractCalcLib.lvlibp/AbstractCalc/AbstractCalc.lvclass"/>
			<Item Name="BuildHelpPath.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/BuildHelpPath.vi"/>
			<Item Name="Check Special Tags.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Check Special Tags.vi"/>
			<Item Name="Clear Errors.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Clear Errors.vi"/>
			<Item Name="Convert property node font to graphics font.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Convert property node font to graphics font.vi"/>
			<Item Name="Details Display Dialog.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Details Display Dialog.vi"/>
			<Item Name="DialogType.ctl" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/DialogType.ctl"/>
			<Item Name="DialogTypeEnum.ctl" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/DialogTypeEnum.ctl"/>
			<Item Name="Error Cluster From Error Code.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Error Cluster From Error Code.vi"/>
			<Item Name="Error Code Database.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Error Code Database.vi"/>
			<Item Name="ErrWarn.ctl" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/ErrWarn.ctl"/>
			<Item Name="eventvkey.ctl" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/event_ctls.llb/eventvkey.ctl"/>
			<Item Name="Find Tag.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Find Tag.vi"/>
			<Item Name="Format Message String.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Format Message String.vi"/>
			<Item Name="General Error Handler Core CORE.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/General Error Handler Core CORE.vi"/>
			<Item Name="General Error Handler.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/General Error Handler.vi"/>
			<Item Name="Get LV Class Default Value.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/LVClass/Get LV Class Default Value.vi"/>
			<Item Name="Get String Text Bounds.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Get String Text Bounds.vi"/>
			<Item Name="Get Text Rect.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/picture/picture.llb/Get Text Rect.vi"/>
			<Item Name="GetHelpDir.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/GetHelpDir.vi"/>
			<Item Name="GetRTHostConnectedProp.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/GetRTHostConnectedProp.vi"/>
			<Item Name="Longest Line Length in Pixels.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Longest Line Length in Pixels.vi"/>
			<Item Name="LVBoundsTypeDef.ctl" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/miscctls.llb/LVBoundsTypeDef.ctl"/>
			<Item Name="LVRectTypeDef.ctl" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/miscctls.llb/LVRectTypeDef.ctl"/>
			<Item Name="NI_PackedLibraryUtility.lvlib" Type="Library" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/LVLibp/NI_PackedLibraryUtility.lvlib"/>
			<Item Name="Not Found Dialog.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Not Found Dialog.vi"/>
			<Item Name="Search and Replace Pattern.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Search and Replace Pattern.vi"/>
			<Item Name="Set Bold Text.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Set Bold Text.vi"/>
			<Item Name="Set String Value.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Set String Value.vi"/>
			<Item Name="Simple Error Handler.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Simple Error Handler.vi"/>
			<Item Name="TagReturnType.ctl" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/TagReturnType.ctl"/>
			<Item Name="Three Button Dialog CORE.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Three Button Dialog CORE.vi"/>
			<Item Name="Three Button Dialog.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Three Button Dialog.vi"/>
			<Item Name="Trim Whitespace.vi" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Trim Whitespace.vi"/>
			<Item Name="whitespace.ctl" Type="VI" URL="../../../PPL/AbstractCalcLib.lvlibp/1abvi3w/vi.lib/Utility/error.llb/whitespace.ctl"/>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="ClientDialogs.dll" Type="Document" URL="../../DotNet/ClientDialogs/ClientDialogs/bin/Debug/ClientDialogs.dll"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Finite Measurement Application" Type="EXE">
				...
				<Property Name="Source[0].itemID" Type="Str">{03C39D9E-5030-47CA-B2B2-EC5F7E728EAD}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/SOC_FM Main.vi</Property>
